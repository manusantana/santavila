...
C["tumbonas"] = (
 ...
 "<p><strong>Las tumbonas de exterior de Santavila están diseñadas para el descanso en el jardín y junto a la piscina, resistiendo el sol, la humedad y el cloro.</strong> Disponibles en <strong>aluminio</strong> y en <strong>resina</strong> con diseño de tablillas, muchas con <strong>respaldo reclinable</strong> en varias posiciones y <strong>ruedas integradas</strong> para moverlas sin esfuerzo.</p>"
 + faq([
...
C["accesorios"] = (
 ...
 "<p><strong>Completa tus muebles de exterior con los accesorios de Santavila: bases y pies de parasol, cojines, colchonetas para tumbona y fundas protectoras.</strong> Piezas pensadas para aportar comodidad y para <strong>proteger y alargar la vida</strong> de tu mobiliario frente al sol, la lluvia y el polvo.</p>"
 + faq([
